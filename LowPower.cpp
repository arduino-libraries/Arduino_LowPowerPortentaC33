...
LowPower::LowPower(){
    ...
    lpm_voluntary_sleep_cfg.power_supply_state = LPM_POWER_SUPPLY_DEEPCUT0; // LPM_POWER_SUPPLY_DEEPCUT0, LPM_POWER_SUPPLY_DEEPCUT1, LPM_POWER_SUPPLY_DEEPCUT3
    lpm_voluntary_sleep_cfg.output_port_enable = LPM_OUTPUT_PORT_ENABLE_RETAIN; // LPM_OUTPUT_PORT_ENABLE_RETAIN LPM_OUTPUT_PORT_ENABLE_HIGH_IMPEDANCE
    lpm_voluntary_sleep_cfg.io_port_state = LPM_IO_PORT_NO_CHANGE;  // LPM_IO_PORT_NO_CHANGE LPM_IO_PORT_RESET
...
void LowPower::setWakeupPin(uint8_t pin){
    ...
    lpm_voluntary_sleep_cfg.standby_wake_sources = standby
}
